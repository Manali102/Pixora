      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={cn(
              "absolute left-1/2 -translate-x-1/2 px-3 py-1.5 bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 text-sm font-bold rounded-lg whitespace-nowrap z-[100] shadow-xl pointer-events-none",
              positionClasses
            )}
          >
            {content}
